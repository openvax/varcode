...
"""Experimental hypothesis → product → classification effect engine."""
...
def predict_realized_effect(
    ...
    if not variants:
        raise ValueError("predict_realized_effect requires a somatic variant")
...
class RealizedEffectAnnotator:
    """Opt-in annotator backed by the composable realized-effect pipeline."""
